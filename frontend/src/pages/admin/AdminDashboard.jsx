      ...
      <div className="animate-fade-up">
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', gap: 'var(--space-3)', flexWrap: 'wrap' }}>
            <Link to="/admin/resources"><button className="btn btn--secondary">Manage Resources</button></Link>
            <Link to="/admin/users"><button className="btn btn--secondary">Manage Users</button></Link>
          </div>
        </div>
      </div>
    </DashboardLayout>
